...
load("crwplots.RData")
load("crwSTplots.RData")
load("spatialSimStudyplots.RData")
load("STplots.RData")
load("spatialSimStudyplots_noLangevin.RData")
load("crwplotDens.RData")
load("crwSTplotDens.RData")
load("spatialStudyplotDens.RData")
load("STplotDens.RData")
load("spatialStudyplotDens_noLangevin.RData")

base_size <- 14

pdf("crwViterbiPlots.pdf",width=8,height=11)
...
pdf("crwBeta12Plots.pdf",width=8,height=11)
...
pdf("crwBeta21Plots.pdf",width=8,height=11)
...
pdf("spatViterbiPlots.pdf",width=8,height=11)
...
pdf("spatBeta12Plots.pdf",width=8,height=11)
...
pdf("spatBeta21Plots.pdf",width=8,height=11)
...
pdf("STViterbiPlots.pdf",width=11,height=8)
...
pdf("STBetaPlots.pdf",width=11,height=8)
...
pdf("spat_noLangevinViterbiPlots.pdf",width=8,height=11)
...
pdf("spat_noLangevinBeta12Plots.pdf",width=8,height=11)
...
pdf("spat_noLangevinBeta21Plots.pdf",width=8,height=11)
...
pdf("crwDensPlots.pdf",height=11,width=8)
...
pdf("crwSTDensPlots.pdf",height=11,width=8)
...
pdf("spatialStudyplotDens.pdf",height=11,width=8)
...
pdf("STDensPlots.pdf",height=11,width=8)
...
pdf("spatialStudyplotDens_noLangevin.pdf",height=11,width=8)
